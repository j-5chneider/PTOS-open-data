...
* Informed consent must therefore fulfill a number of requirements
  - purpose of data collection (includes *sharing the data* and *future use*)<br />-> therefore often "broad consent"
